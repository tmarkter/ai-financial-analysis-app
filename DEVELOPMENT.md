...
```bash
git remote add encore encore://ai-financial-analysis-app-sms2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-financial-analysis-app-sms2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-financial-analysis-app-sms2/settings/integrations/github)
