...
export default function WidgetShell({
  ...
  return (
    <section 
      className="rounded-2xl bg-neutral-900 border border-neutral-800 p-4 flex flex-col"
      style={{ minHeight }}
    >
      ...
      <div className="flex-1">
        ...
        {!isLoading && error && (
          <div className="h-full grid place-items-center text-red-400 text-sm text-center px-4">
            {error}
          </div>
        )}
